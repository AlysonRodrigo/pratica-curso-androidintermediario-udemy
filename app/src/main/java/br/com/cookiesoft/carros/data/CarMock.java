package br.com.cookiesoft.carros.data;
...
public class CarMock {
    ...
    public List<Car> getCarMockList(Activity activity) {
        ...
        int id = 0;
        Car audiR8 = new Car(id, "Audi R8", "Audi", 610, Double.valueOf(165338.00), ContextCompat.getDrawable(activity, R.drawable.audir8));
